  ...
  return (
    <PublicLayout>
      <div className="relative overflow-hidden text-white bg-transparent">
        ...
        {/* Hero Section */}
        <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <Floating distance={8} duration={6} delay={0.8}>
                <FloatingCard
                  ...
                  subtitle="Verifiable on blockchain"
                  badge="Serialized"
                />
              </Floating>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10 border-t border-white/5 bg-white/[0.02] backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              {/* Challenge */}
              <FadeUp delay={0.1}>
                <div className="glass-card p-8 sm:p-10 border border-white/10 relative overflow-hidden flex flex-col md:flex-row gap-6 items-center">
              ...
              {/* Solution */}
              <FadeUp delay={0.25}>
                <div className="glass-card p-8 sm:p-10 border border-primary-500/20 relative overflow-hidden flex flex-col md:flex-row gap-6 items-center">
                  <div className="flex-1">
